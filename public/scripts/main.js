...
iconApp.events = function () {
    $('.icons').click(function () {
        $(this).find('.flex').css('background', '#EF6154');
        if (this.id === iconApp.randomIcon) {
            $('.wrong').fadeOut();
            $.APP.stopTimer();
            $('.icons').unbind('click');
            $('.timer').clone().appendTo('.correct p');
            $('.correct').fadeIn();
